    ...
    {plantsDetails ? (
        ...
        <Container className="plant__details">
          <Row className="d-flex justify-content-between">
            ...
            <Col xs={6} sm={6} lg={4} className="d-flex justify-content-center mt-5">
              <p>{plantsDetails.sellerId.username} &nbsp;</p>          
              <p className="seller__role__text">
                ({plantsDetails.sellerId.role}) &nbsp;
              </p>

              {/* stars below are representative, should work on seller average */}
              <FaStar color={"#ffc107"} /> 
              <FaStar color={"#ffc107"} />
              <FaStar color={"#ffc107"} />
              <FaStar color={"#ffc107"} />
            ...
            <Col xs={6} sm={6} lg={4} className="d-flex justify-content-center mt-4">
          ...
          <Row className="mt-5">
              <h1 className="margin__left">{plantsDetails.price} €</h1>
          </Row>
          <Row className="mt-2">
